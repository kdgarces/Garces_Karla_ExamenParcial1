...
El polimorfismo se demuestra mediante los métodos `retirar()` y `procesar_fin_de_mes()`. El programa utiliza las mismas llamadas:
...
Python ejecuta automáticamente la implementación correspondiente al tipo real del objeto. En una cuenta de ahorros, el procesamiento mensual agrega intereses; en una cuenta corriente, cobra una comisión.
...
- Saldo inicial: $2,000.
- Comisión mensual: $5.
- Saldo después de la comisión: $1,995.
- Un retiro de $1,200 es rechazado por superar el límite permitido ($1,000).
